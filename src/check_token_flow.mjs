...
try{
  ...
  assert.equal(await page.locator('#s12 .frame').count(),9,'A topic break precedes the worked pair, live draws, summary, variance derivation, two softmax calculations, explanation and bank comparison.');
