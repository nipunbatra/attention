...
The arithmetic passage finishes Head 1 before starting Head 2. Each head starts
with numerical Q/K rows, the final query times Kᵀ and all ten softmax terms.
Value mixing then uses four held frames: alpha weights, matching V rows,
