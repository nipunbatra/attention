...
- [Vision I](https://nipunbatra.github.io/attention/vision1.html): a complete 140-frame lecture plus cover: real-photo motivation, exact four-patch/two-head arithmetic, full ViT code, actual training on independent synthetic splits, and measured real-image attention and occlusion. Includes an executed [complete lab](notebooks/vision/03_vision_transformer_lab.ipynb) and [teaching guide](src/VISION1_TEACHING_GUIDE.md).
